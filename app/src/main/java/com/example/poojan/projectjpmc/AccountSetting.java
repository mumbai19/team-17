...
public class AccountSetting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!user.getUserImgUrl().equals("no")){
                    Glide.with(getApplicationContext()).load(user.getUserImgUrl()).apply(new RequestOptions().circleCrop()).into(userImg);
                }
            }
        ...
        userImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ActivityCompat.checkSelfPermission(AccountSetting.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
